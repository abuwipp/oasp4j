package io.oasp.tddsamples.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see io.oasp.tddsamples.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see io.oasp.tddsamples.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
