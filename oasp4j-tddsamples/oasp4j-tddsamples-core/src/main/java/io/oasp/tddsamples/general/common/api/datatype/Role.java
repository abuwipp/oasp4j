package io.oasp.tddsamples.general.common.api.datatype;

import java.security.Principal;

/**
 * Defines the available roles of a {@link io.oasp.tddsamples.staffmanagement.common.api.StaffMember}.
 *
 * @see io.oasp.tddsamples.staffmanagement.common.api.StaffMember#getRole()
 *
 * @author hohwille
 * @author loverbec
 */
public enum Role implements Principal {
   ...
   * {@link io.oasp.tddsamples.staffmanagement.common.api.StaffMember}s.
   */
  CHIEF("Chief"),
